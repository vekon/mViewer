...
class SideNavComponent extends React.Component {
  ...
  componentDidMount(){
    ...
    const homeUrl = window.location.href.split('?')[0].search("/home") != -1;
    const collectionUrl = window.location.href.split('?')[0].search("/database") != -1;
    const graphsUrl = window.location.href.split('?')[0].search("/mongoGraphs") != -1;
    const statsUrl = window.location.href.split('?')[0].search("/serverStats") != -1;
