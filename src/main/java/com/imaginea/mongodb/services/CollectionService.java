...
/**
 * Defines services for performing operations like create/drop on collections inside a database
 * present in mongo to which we are connected to. Also provides service to get list of all
