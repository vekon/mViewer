...
/**
 * Defines resources for getting statistics of mongo Server and statistics of a particualr database
 * present in mongo and statistics of a collection present inside a database.
 * <p/>
 * The resources also form a error JSON response when any exception occur while performing the
 * operation.
 *
