 ...
 * services files. GET and POST request resources for databases are defined
...
public class DatabaseController extends BaseController {
	...
	public String executeQuery(@PathParam("dbName") final String dbName, @QueryParam("query") final String query,
			...
			@QueryParam("sortBy") final String sortBy, @Context final HttpServletRequest request) {
		String response = new ResponseTemplate().execute(logger, connectionId, request, new ResponseCallback() {
			@Override
			public Object execute() throws Exception {
				// Get query
