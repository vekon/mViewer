...
/**
 * Defines validation functions for validating dbInfo from session. An error JSON object is returned
 * when dbInfo is found invalid.
 *
...
public class BaseController {
   ...
   */
  protected static String validateConnectionId(String connectionId, Logger logger,
    ...
    // InvalidHTTPRequestException e = new
    // InvalidHTTPRequestException(ErrorCodes.INVALID_CONNECTION, "Invalid Connection");
    // return formErrorResponse(logger, e);
    // }
    return response;
  }
  ...
  protected static class ErrorTemplate {
    ...
    public static String execute(Logger logger, ResponseCallback callback, boolean wrapResult) {
      ...
      try {
        ...
        ApplicationException e = new ApplicationException(ErrorCodes.JSON_EXCEPTION,
            "Invalid JSON Object", m.getCause());
        ...
        ApplicationException e =
            new ApplicationException(ErrorCodes.ANY_OTHER_EXCEPTION, m.getMessage(), m);
        response = formErrorResponse(logger, e);
      }
      return response;
    }
