...
public class DatabaseQueryExecutor {
    ...
    public static JSONObject executeQuery(MongoDatabase db, String command, String queryStr, String fields, String sortByStr, int limit, int skip) throws JSONException, InvalidMongoCommandException {
